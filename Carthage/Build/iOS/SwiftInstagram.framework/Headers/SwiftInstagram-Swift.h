...
SWIFT_MODULE_NAMESPACE_PUSH("SwiftInstagram")
@class NSCoder;
@class NSBundle;

SWIFT_CLASS("_TtC14SwiftInstagram28InstagramLoginViewController")
...
@interface InstagramLoginViewController (SWIFT_EXTENSION(SwiftInstagram)) <WKNavigationDelegate>
